...
import styles from './AddLearning.module.css';
            ...
            >
              ...
              <div className={styles.formGroup}>
                ...
                >
                  ...
                  <option value="Signature Technique">Signature Technique</option>
                  <option value="Flavor Philosophy">Flavor Philosophy</option>
                  <option value="Iconic Dish">Iconic Dish</option>
                  <option value="Mentor/Influence">Mentor/Influence</option>
                  <option value="Kitchen Non-Negotiable">Kitchen Non-Negotiable</option>
                </select>
              </div>
              <div className={styles.formGroup}>
