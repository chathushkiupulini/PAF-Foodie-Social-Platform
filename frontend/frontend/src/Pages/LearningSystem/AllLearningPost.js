        ...
        <main>
          <div className="learning-header">
            <div className="learning-header-content">
              ...
              <Utensils size={28} color="#FF7F50" />
                .  Culinary Creations Network
              </h1>
              <p className="learning-subtitle">
              Share your kitchen masterpieces and discover delicious inspiration from chefs worldwide              </p>
            </div>
            ...
            <div className="learning-form-overlay">
              <div className="learning-form">
                <div className="learning-form-header">
                  <h2 className="learning-form-title">Share Your Cooking Knowledge</h2>
                  <p className="learning-form-subtitle">Help others improve their cooking skills</p>
                  <button
          ...
          {isLoading ? (
            ...
            <div className="learning-empty">
              ...
              <h3>No Photography Tutorials Found</h3>
              <p>{searchQuery || selectedFilter !== "all" ? 
                  "Try adjusting your search or filters" : 
                  "Be the first to share your photography expertise!"}
              </p>
            ...
            <>
              <div className="learning-results-info">
                <span>Showing {filteredPosts.length} {filteredPosts.length === 1 ? 'tutorial' : 'tutorials'}</span>
